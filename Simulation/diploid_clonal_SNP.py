...
phased_substitution_wsp = open(output_file_name_prefix+"_substitution.csv",'a')
...
for i in range(depth):
    ...
    difference_array = difference_16(ref_genotype_lis,current_phased)
    subsitution_out_line = ",".join([str(item) for item in difference_array]) + "\n"
    phased_substitution_wsp.write(subsitution_out_line)
